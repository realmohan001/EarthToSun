...
<html>
<head>
<title>Cherry Sports Bids:Modify Auction Manager</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-12 col-xs-12">
				...
				<h4 class="text-left">Modify Item</h4>


				<form:form method="post" commandName="ITEM_MODIFY_MANAGER"
					action="ModifyItemSubmit" enctype="multipart/form-data" class="form-horizontal" role="form">
						...
						<!-- THESE ARE TO HOLD THE IMAGE LOCATION -->
									<form:hidden path="itemImageLocation1"/>
									<form:hidden path="itemImageLocation2"/>
									<form:hidden path="itemImageLocation3" /> 
									<form:hidden path="itemImageLocation4" /> 
									<form:hidden path="itemImageLocation5" />
