...
<html>
<head>
<title>Cherry Sports Bids:Foundation/Business Registration Page</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-12 col-xs-12 text-center">
				...
				<h4 class="text-left">Foundation Account Registration</h2>

				<form:form method="POST" commandName="REGISTER_CUSTOMER"
					action="RegisterBusinessCustomerSubmit.htm" class="form-horizontal" role="form">
					...
					<form:errors path="*">								
						...
						<div class="form-group">			
							<label class="col-sm-2 control-label"><span class="requiredField">*</span>Business/Foundation Name</label>
							<div class="col-sm-4">
