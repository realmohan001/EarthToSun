...
<html>
<head>
<title>Cherry Sports Bids:User ID Info</title>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9 col-xs-12">
				...
				<form:form method="POST" commandName="ACCOUNT_MANAGER"
					action="UserIDDetails.htm" class="form-horizontal" role="form">
				...
				<div>
					<c:if test="${not empty SUCCESS_RESULT}">
						...
						<h4 class="text-left">Current User ID Details</h4>
						
						<div class="form-group">						
							<label class="col-sm-2 control-label">Current User ID</label>
							
							<div class="col-sm-3">
							<p class="form-control-static">${userData.customer.userId }</p>
									</div>
						</div>
						
						<div class="form-group">						
							<label class="col-sm-2 control-label"><span class="requiredField">*</span>Current
								Password</label>
							
							<div class="col-sm-3">
							<form:password
									path="currentUserPassword" class="form-control input-sm" placeholder="Enter current password" />							
									</div>
						</div>
						
						<div class="form-group">						
							<label class="col-sm-2 control-label"><span class="requiredField">*</span>Enter
								New User ID</label>
							
							<div class="col-sm-3">
							<form:input path="newUserId" class="form-control input-sm" placeholder="Enter new User ID" />					
									</div>
						</div>							
					...
					<input type="submit"
								value="Update" /> <input type="button" value="Cancel" onclick="location.href='${pageContext.request.contextPath}/'" />
