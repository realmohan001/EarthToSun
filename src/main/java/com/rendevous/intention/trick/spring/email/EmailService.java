...
public class EmailService {
     ...
     */
    public void sendSimpleMail(final String recipientEmail, final String recipientEmailSubject, final String fromEmail, final String templateName, final Context ctx, final Locale locale) 
        ...
        message.setSubject(recipientEmailSubject);
        ...
        System.out.println("message--2--->"+message.toString());
        
        // Send email
        this.mailSender.send(mimeMessage);
        
        System.out.println("message--3--->"+message.toString());
